...
public class AdminClient {
	...
	AdminFlipFitService adminFlipFitService = new AdminFlipFitService();

	List<GymOwner> gymOwnerList = adminFlipFitService.getGymOwners();
	List<Gym> gymList = adminFlipFitService.getGym();
	Scanner sc = new Scanner(System.in);
	
	public void viewAllPendingGymOwnerRequests() {
		viewAllGymOwners(adminFlipFitService.viewAllPendingGymOwnerRequests());
	}
	public void viewAllPendingGymRequests() {
		viewAllGyms(adminFlipFitService.viewAllPendingGymRequests());
	}
	
	public void approveSingleGymOwnerRequest() {
		System.out.println("Enter gym owner email: ");
		adminFlipFitService.approveSingleGymOwnerRequest(sc.next());
	}
	
	public void approveSingleGymRequest() {
		System.out.println("Enter gym Id: ");
		adminFlipFitService.approveSingleGymRequest(sc.next());
	}

	public void approvePendingGymOwnerRequests() {
		adminFlipFitService.approveAllPendingGymOwnerRequests();
	}

	public void approvePendingGymRequests() {
		adminFlipFitService.approveAllPendingGymRequests();
	}
