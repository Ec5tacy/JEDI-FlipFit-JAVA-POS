...
import com.flipkart.DAO.AdminFlipFitDAOImpl;
 ...
 */
public class AdminFlipFitServiceImpl implements AdminFlipFitServiceInterface {
	AdminFlipFitDAOImpl adminDAO = new AdminFlipFitDAOImpl();
	/**
